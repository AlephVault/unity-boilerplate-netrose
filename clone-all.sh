...
git clone --branch 0.0.1 git@github.com:AlephVault/unity-camjam.git ../unity-camjam
...
git clone --branch 0.0.3 git@github.com:AlephVault/unity-meetgard.git ../unity-meetgard
git clone --branch 0.0.3 git@github.com:AlephVault/unity-meetgard-auth.git ../unity-meetgard-auth
